package ma.lndroid.tp.entity.manager.collection.mapping.set;
...
import ma.lndroid.tp.entity.manager.collection.mapping.set.dto.Address;
import ma.lndroid.tp.entity.manager.collection.mapping.set.dto.SetEmployee;
...
public class Main {
	...
	private static void insertingAnEntity(EntityManagerFactory emf,
		...
		try {
			...
			SetEmployee e1 = new SetEmployee("EMP1");
			...
			SetEmployee e2 = new SetEmployee("EMP1");
